...
<table style="border-collapse: collapse; border: none;">
  <tr>
    <td valign="top" width="65%">
      ...
      <ul>
        <li>🌱 Data engineering experience at Localiza&CO.</li>
        <li>🔭 Full stack web programming at Programadores do Amanhã.</li>
        <li>🧐 Communicative and proactive, looking for opportunities.</li>
      </ul>
      <p>I intend to develop my blockchain skills, so I am combining full-stack development with data engineering.</p>
    </td>
